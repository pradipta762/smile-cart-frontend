  ...
  return (
    <div className='neeto-ui-rounded neeto-ui-border-black border p-2'>
      <div className='flex w-full items-center space-x-5'>
        <img src={imageUrl} height={80} width={80} alt={name} />
        <div className='flex-grow space-y-1'>
          <Typography className='mb-2' style="h4">{name}</Typography>
        ...
        <div className='flex items-center space-x-2'>
          ...
          <Alert
            ...
            message={
              <Typography>
                You are removing <strong>{name}</strong> from cart. Do you want to continue?
              </Typography>
            }
